		...
		if($success){
			...
			if($new_user_id) {
				...
				if( isset( $_POST['popupaction'] ) && !empty($_POST['popupaction']) && $_POST['popupaction'] == 'popupsignup' ){
				    $data['popup_success'] = '<span>You have successfully registerd</span> <a id="goSinginTabpopUp" href="#login">Sign in here</a>';
				} else{
