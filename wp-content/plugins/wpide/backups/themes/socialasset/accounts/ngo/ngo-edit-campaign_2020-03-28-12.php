        ...
        <div class="pr-190">
         ...
         <div class="sa-selctpicker-ctlr">
            <select name="businessids[]" class="selectpicker multiple-select" multiple>
                <option value="0" disabled selected="selected">Choose User</option>
                <?php if($users): foreach ( $users as $user ) { ?>
                <option value="<?php echo $user->ID; ?>" <?php if(in_array( $user->ID, $useridExp )): 'selected="selected"'; endif;?> ><?php echo $user->display_name; ?></option>
                <?php } endif; ?>
            </select>
          </div>
        </div>
