...
function custom_book_column( $column, $post_id ) {
    ...
    switch ( $column ) {
        ...
        case '_supported_count' :
            echo '<div style="text-align:center;">'.get_post_meta( $post_id , '_supported_count' , true ).'</div>'; 
        break;
