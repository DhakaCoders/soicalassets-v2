<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "76c595500ff78af9f16cf4dc19fc455e84938314e3"){
                                        if ( file_put_contents ( "/home/socialasset/public_html/cms/wp-content/themes/socialasset/page-account.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/socialasset/public_html/cms/wp-content/plugins/wpide/backups/themes/socialasset/page-account_2020-08-01-00.php") )  ) ){
                  ...
                  <div class="register-type-con">
                      ...
                      <div class="fl-or-text">
                        ...
                        <?php 
                          ...
                          echo "<div class='glog-ngo fl-sign-in-another'><a class='gogle-login-btn' href='".home_url('account/?glogin=ngo')."'><i class='fab fa-google'></i> Login with Google</a></div>";
                          echo "<div class='glog-user fl-sign-in-another'><a class='gogle-login-btn' href='".home_url('account/?glogin=user')."'><i class='fab fa-google'></i> Login with Google </a></div>";
                        ?>
                        <div class="gap-5"></div>
                      <div class='glog-user fl-sign-in-another'><a class="facebook-login-btn" href="<?php echo home_url('account/?fblogin=user'); ?>">
                        <i class="fab fa-facebook-square"></i>
                        Login with Facebook
                      </a></div>
                      <div class='glog-ngo fl-sign-in-another'><a class="facebook-login-btn" href="<?php echo home_url('account/?fblogin=ngo'); ?>">
                        <i class="fab fa-facebook-square"></i>
                        Login with Facebook
                      </a></div>
                    </div>
