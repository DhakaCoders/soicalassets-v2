...
function mo_openid_registration()
{
    ...
    <form id="registration" name="registration" method="post" action="">
        ...
        <div class="mo_openid_table_layout">
            <h3><?php echo mo_sl('Auto Registration');?></h3>
            <div>
                <label class="mo_openid_checkbox_container"><?php echo mo_sl('Auto-register users');?>.
                ...
                <?php echo mo_sl('Registration disabled message');?>:
            ...
            <div>
                <label class="mo_openid_checkbox_container"><?php echo mo_sl('Enable Email Notification to Admin - on User Registration');?>
                ...
                <label style="cursor: auto" class="mo_openid_note_style"><?php echo mo_sl('This feature requires SMTP to be configured');?>.</label>
            </div>
            <br/><hr>
            <h3><?php echo mo_sl('Set Display Picture for User');?></h3>
            <div>
                <label class="mo_openid_checkbox_container"><?php echo mo_sl('Set Display Picture for User - on User Registration');?>
