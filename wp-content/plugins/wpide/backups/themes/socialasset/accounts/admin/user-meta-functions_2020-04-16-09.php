...
//making the meta box (Note: meta box != custom meta field)
function wpse_add_custom_meta_box_videourl() {
   add_meta_box(
       'custom_meta_videourl',       // $id
       'Video URL',                  // $title
       'show_custom_meta_box_videourl',  // $callback
       'campaigns',                 // $page
       'normal',                  // $context
       'high'                     // $priority
   );
}
add_action('add_meta_boxes', 'wpse_add_custom_meta_box_videourl');

//showing custom form fields
function show_custom_meta_box_videourl() {
    global $post;
...
//now we are saving the data
function wpse_save_meta_fields_videourls( $post_id ) {
...
add_action( 'save_post', 'wpse_save_meta_fields_videourls' );
add_action( 'new_to_publish', 'wpse_save_meta_fields_videourls' );