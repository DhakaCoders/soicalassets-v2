<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9ec84427d2fe8cc0eeda12a025f22b2c40742e5c45"){
                                        if ( file_put_contents ( "/home/socialasset/public_html/cms/wp-content/themes/socialasset/single-campaigns.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/socialasset/public_html/cms/wp-content/plugins/wpide/backups/themes/socialasset/single-campaigns_2020-04-17-14.php") )  ) ){
...
<div id="customSidebar" class="hide-lg">
  <div class="miracle-plan-des-wrp">
    <div class="miracle-plan-des-innr">
      ...
      <h3>The miracle recovery plan for our planet</h3>
      ...
      <div class="miracle-plan-progress-camp">
        <ul class="ulc clearfix">
          <li>
            <i>
              <img src="assets/images/miracle-plan-des-icon-1.png" alt="">
            </i>
            <i>
              <img src="assets/images/miracle-plan-des-icon-2.png" alt=""> 
            </i>                
          </li>
          <li>
        ...
        <div class="miracle-plan-progress-bar-con">
          <div class="miracle-plan-progress-top-des clearfix">
            <span>Support</span>
            <span><strong class="progress-par">50</strong>%</span>
          </div>
          ...
          <div class="miracle-plan-progress-link-wrp">
            <a class="support-btn" href="#"><i class="far fa-heart"></i>SUPPORT THIS CAMPAIGN</a>
          ...
          <div class="miracle-plan-slider-wrp">
            <div class="miraclePlanBigSlider">
              <div class="miraclePlanBigSlider-item">
                <a class="img-zoom" data-fancybox="Miracle Plan" href="https://www.youtube.com/watch?v=b4Yx9eHfsuc">
                  <span>
                    <i><img src="assets/images/plan-play.png" alt=""></i>     
                  </span>  
                  <div class="miracle-plan-video-bg" style="background: url('assets/images/miracle-plan-slider-bg.jpg')">
                  </div>
                </a>   
              </div>
              <div class="miraclePlanBigSlider-item">
                <div class="miraclePlanBigSlider-item-bg" style="background: url('assets/images/miracle-plan-slider-bg.jpg')">
                </div>
              </div>
              <div class="miraclePlanBigSlider-item">
                <div class="miraclePlanBigSlider-item-bg" style="background: url('assets/images/miracle-plan-slider-bg.jpg')">
            ...
            <div class="miraclePlanthumbSlider clearfix">
              <span class="miraclePlanthumbSlider-item">
                <img src="assets/images/miraclePlanthumb-1.png" alt="">
              </span>
              <span class="miraclePlanthumbSlider-item">
                <img src="assets/images/miraclePlanthumb-2.png" alt="">
              </span>
              <span class="miraclePlanthumbSlider-item">
                <img src="assets/images/miraclePlanthumb-3.png" alt="">
              </span>
            </div>
          </div>
...
<section class="miracle-plan-sec" style="display:none">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <?php 
        ...
        <div class="miracle-plan-innr clearfix">
          <div class="miracle-plan-slider-wrp">
          	...
          	<?php } ?>
                ...
                <div class="miraclePlanBigSlider-item">
                    <div class="fancybox-video">
                        <a <?php echo $atag; ?>>
                          <div class="fancybox-img" style="background-image: url(<?php echo get_video_fullsize($video_url); ?>);">
                            <img src="<?php echo get_video_fullsize($video_url); ?>" alt="">
            ...
            ?>
            <span class="miraclePlanthumbSlider-item">
               <img src="<?php echo get_video_thumbnail($video_url); ?>" alt="">
            </span>
