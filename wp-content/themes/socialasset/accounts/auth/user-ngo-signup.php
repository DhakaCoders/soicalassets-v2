		...
		if($success){
			...
			if($new_user_id) {
				...
				if( isset( $_POST['popupaction'] ) && !empty($_POST['popupaction']) && $_POST['popupaction'] == 'popupsignup' ){
				    $data['popup_success'] = '<span>You have successfully registered</span> <a id="goSinginTabpopUp" href="#login">Sign in here</a>';
				} else{
	                $data['signup_success'] = 'We have received your registration request. We will review your request and will contact with you within 72 hours.';
				}
