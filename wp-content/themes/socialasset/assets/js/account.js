...
$('.register-ngo-btn').on('click', function(){
  ...
  $('#user-type-selection').selectpicker('refresh');
    $(this).parents('#user-signup').removeClass();
    $(this).parents('#user-signup').addClass('Ngo');
});

$('.register-ngo-btn.businessbtn').on('click', function(){
  $('.ngo-name').show();
  $('.user-name').hide();
  $('#user-type-selection').val('Business');
  $('#user-type-selection').selectpicker('refresh');
});
...
$('.register-supporter-btn').on('click', function(){
  ...
  $('#user-type-selection').selectpicker('refresh');
    $(this).parents('#user-signup').removeClass();
    $(this).parents('#user-signup').addClass('User');
});
...
$('#user-type-selection').on('change', function(){
    ...
    $("#show"+thisval).show();
    $(this).parents('#user-signup').removeClass();
    $(this).parents('#user-signup').addClass(thisval);
});
...
$('#goSinginTab').on('click', function(e){
  e.preventDefault();
    $('div.fl-tabs button').removeClass('current');
    $('.fl-tab-content').removeClass('current');
    $('div.fl-tabs button[data-tab="tab-2"]').addClass('current');
    $("#tab-2").addClass('current');
    //goToByScroll('.fl-login-form', 50);
});


$('#goSinginTabpopUp').on('click', function(e){
  e.preventDefault();
    $('div.fl-tabs button').removeClass('current');
    $('.fl-tab-content').removeClass('current');
    $('div.fl-tabs button[data-tab="tab-2"]').addClass('current');
...
$('body').on('click', '#goSinginTabpopUp', function(e){
  e.preventDefault();
    $('div.fl-tabs button').removeClass('current');
    $('.fl-tab-content').removeClass('current');
    $('div.fl-tabs button[data-tab="tab-2"]').addClass('current');
