              ...
              //console.log(attachments[i].id);
                  ...
                  if(attachments[i].attributes.type == 'video'){
                    if( duplicateID != attachments[i].id ){
                      ...
                      attachments[i].id +'"><div class="ncc-campaign-gallery-add-img"><video> <source src="'+attachments[i].attributes.url + '" type="video/mp4"></video><input id="myplugin-image-input' + 
