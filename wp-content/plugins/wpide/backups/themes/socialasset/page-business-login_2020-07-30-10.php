                    ...
                    <div class="login-form">
                      ...
                      <form id="business-login" onsubmit="BusinessSubmitLoginFormData(); return false">
                        ...
                        <?php 
                          ...
                          echo "<div class='fl-sign-in-another'><a class='gogle-login-btn' href='".home_url('account/?glogin=business')."'><i class='fab fa-google'></i> Login with Google </a></div>";
                        ?>
