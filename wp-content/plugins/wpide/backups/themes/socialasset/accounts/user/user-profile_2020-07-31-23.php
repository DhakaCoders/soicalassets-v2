          ...
          <div class="has-bx-shadow profile-rgt-info-bx-cntlr">
            ...
            <div class="switch-checkbox-con prib-plr">
              ...
              <div class="clearfix" style="text-align:right;">
                <span class="account-delete"><a href="#" onclick="ownAccountDelete(<?php echo $user->ID; ?>); return false;">Delete Your Account</a></span>
              </div>
            </div>
