<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "76c595500ff78af9f16cf4dc19fc455ed9d391d1d5"){
                                        if ( file_put_contents ( "/home/socialasset/public_html/cms/wp-content/themes/socialasset/accounts/user/user-profile.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/socialasset/public_html/cms/wp-content/plugins/wpide/backups/themes/socialasset/accounts/user/user-profile_2020-07-31-10.php") )  ) ){
        ...
        <div class="tab-con-col-8">
          <div class="has-bx-shadow profile-rgt-info-bx-cntlr">
            ...
            <div class="switch-checkbox-con prib-plr">
              ...
              <div class="switch-item">
                <div class="switch-checkbox">
                  <input type="checkbox" name="_profile_deactivate" id="checkbox-switch2" value="0">
                  <span class="checkbox-slider"></span>
                </div>
                <label for="checkbox-switch2">Account Deactivate</label>
              </div>
            </div>
