                  ...
                  <div class="register-type-con">
                      ...
                      <div class="fl-or-text">
                        ...
                        <?php 
                          ...
                          echo "<div class='fl-sign-in-another'><a class='gogle-login-btn' href='".home_url('account/?glogin=ngo')."'>Login with Google</a></div>";
                          echo "<div class='fl-sign-in-another'><a class='gogle-login-btn' href='".home_url('account/?glogin=user')."'>Login with Google </a></div>";
                        ?>
                    </div>
                  </form>
          </div>
