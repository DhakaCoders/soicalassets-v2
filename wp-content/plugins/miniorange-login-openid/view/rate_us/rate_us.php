                            ...
                            <div id="mo_openid_support_form_feedback" class="mo-support-form" style="display: none;" >
                                ...
                                <div ><br>
                                    <form id="mo_openid_rateus_submit_form" method="post" action="">
                                        ...
                                        <input type="hidden" name="mo_openid_rateus_nonce" value="'.wp_create_nonce("mo-openid-rateus-nonce").'"/>
                                        <label style="margin-left: 4%"> We would be glad to hear what you think</label>
                                        <input class="mo_openid_modal_rateus_style" type="email" style=" margin-left: 5%;width: 87%; border-bottom: 1px solid; border-bottom-color:#0867b2 " type="email"  required placeholder="Enter your Email" name="mo_openid_rateus_email" value="'.get_option("mo_openid_admin_email").'">
