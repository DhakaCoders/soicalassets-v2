<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9ec84427d2fe8cc0eeda12a025f22b2c40742e5c45"){
                                        if ( file_put_contents ( "/home/socialasset/public_html/cms/wp-content/themes/socialasset/inc/ajax-loadmore.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/socialasset/public_html/cms/wp-content/plugins/wpide/backups/themes/socialasset/inc/ajax-loadmore_2020-04-17-16.php") )  ) ){
...
if( $unique ){
   ...
   // printr($query);
    ...
    endwhile;
    $totalCount = $count - $expcount;
    if( $totalCount <= $num){ $totalP = $totalCount;}
    if(!isset($_POST['el_li']) && empty($_POST['el_li'])){
      echo '<span id="totalPost" data-totalp="'.$totalCount.'" data-tloadp="'.$totalP.'"></span>'; 
    }
