<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "76c595500ff78af9f16cf4dc19fc455edac14ce02e"){
                                        if ( file_put_contents ( "/home/socialasset/public_html/cms/wp-content/themes/socialasset/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/socialasset/public_html/cms/wp-content/plugins/wpide/backups/themes/socialasset/footer_2020-04-20-11.php") )  ) ){
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div id="tab-1" class="fl-tab-content current">
          <div class="tab-con-inr popupsignup-wrapp">
                 <div class="popup-success" style="display:none"></div>
                <form id="user-signup" onsubmit="SubmitSignupFormData(); return false">
                  ...
                  <input type="hidden" name="popupaction" value="popupsignup">
                  <div class="register-hdr-con">
                    <strong>Create your free online account</strong>
                    <span>Already have an account? <a id="goSinginTab" href="#tab-2">Sign in here</a></span>
                  </div>
                  <div class="register-type-btn">
                    <a href="javascript:void(0)" class="register-supporter-btn">I’m Supporter</a>
                    <a href="javascript:void(0)" class="register-ngo-btn businessbtn">
                      Business</span>
                    </a>
                  </div>
                  <div class="register-type-con">
                      ...
                      <div class="fl-input-field-row sa-input ngo-name showCntrl" id="showBusiness">
