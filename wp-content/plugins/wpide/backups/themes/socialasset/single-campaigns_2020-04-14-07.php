<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "9ec84427d2fe8cc0eeda12a025f22b2c22c446ff3d"){
                                        if ( file_put_contents ( "/home/socialasset/public_html/cms/wp-content/themes/socialasset/single-campaigns.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/socialasset/public_html/cms/wp-content/plugins/wpide/backups/themes/socialasset/single-campaigns_2020-04-14-07.php") )  ) ){
              ...
              <div class="miracle-plan-progress-camp">
                ...
                <div id="campaing-progress-bar" class="miracle-plan-progress-bar-con">
                  <div class="miracle-plan-progress-top-des clearfix">
                    <span>Support</span>
                    <span class="percentbar"><strong class="progress-par barcount"><?php echo camp_progress_bar($thisID); ?></strong>% <span class="supporterno"><?php echo total_support_count(get_the_ID()); ?></span></span>
                  </div>
                        ...
                        <div class="campaigns-item-des-btm">
                          ...
                          <div class="campaigns-vote-info">
                            <div class="campaigns-vote-percentage-bar clearfix">
                              <div class="campaigns-vote-percentage-number percentbar"><span><?php echo camp_progress_bar(get_the_ID()); ?>% <?php echo total_support_count(get_the_ID()); ?></span></div>
