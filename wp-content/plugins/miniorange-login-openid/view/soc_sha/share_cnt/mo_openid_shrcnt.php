...
function mo_openid_share_cnt(){
        ...
        <div class="mo_openid_table_layout"><table style="width:100%">
                ...
                <tr>
                    <td>
                        ...
                        <br>
                        <input type="button" id="delete_count_transient" value="<?php echo mo_sl('Delete Count Session');?>" name="delete_count_transient" style="width:150px; margin-bottom: 0px" onclick="delete_transit()" class="button button-primary button-large"/>
                        <br><br>
                    </td>
                </tr>
                <script>
                    ...
                    <td style="width: 100%; ">
                        <div class="mo_openid_sharecount " >
                            ...
                            <div style="font-size: 14px;">
                                <b><?php echo mo_sl('Facebook Access Token');?></b> <input class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 50%" type="text" name="mo_openid_Facebook_share_count_api" value="<?php echo esc_attr(get_option('mo_openid_Facebook_share_count_api')); ?>"><br/>
                                <p><b><?php echo mo_sl('Instructions to configure Facebook Share Counts');?>:</b></p>
                                <ol>
                                    <li><?php echo mo_sl('Go to');?> <a href="https://developers.facebook.com/tools/explorer/" target="_blank">https://developers.facebook.com/tools/explorer/</a>. <?php echo mo_sl('Sign in with your Facebook account');?>.
                                    </li>
                                    <li><?php echo mo_sl('Use an existing app if you already have one or create a new facebook
                                        app by clicking on ');?><b><?php echo mo_sl('Create App');?></b>. <?php echo mo_sl('Go to');?> <b><?php echo mo_sl('My Apps');?></b> <?php echo mo_sl('and
                                        select');?> <b><?php echo mo_sl('Create App');?></b>.<?php echo mo_sl(' Enter Display Name i.e App Name and click
                                        on');?> <b><?php echo mo_sl('Create App ID');?></b>.
                                    </li>
                                    <li><?php echo mo_sl('Go to');?> <b><?php echo mo_sl('Tools');?></b><?php echo mo_sl( 'select');?> <b><?php echo mo_sl('Graph API Explorer');?></b> <?php echo mo_sl('and click on');?> <b><?php echo mo_sl('Get
                                            Access Token');?></b>.
                                    </li>
                                    <li><?php echo mo_sl('Now, go to');?> <a href="https://developers.facebook.com/tools/accesstoken" target="_blank"><?php echo mo_sl('Access Token Tool');?></a> <?php echo mo_sl('and press');?> <b><?php echo mo_sl('Debug');?></b> <?php echo mo_sl('option at right side for the ');?><b><?php echo mo_sl('User Token');?></b></li>
                                    <li><?php echo mo_sl('Now copy the');?> <b><?php echo mo_sl('Access Token');?></b> <?php echo mo_sl('and paste it in the above field and
                                        click on');?> <b><?php echo mo_sl('save');?></b>.
                                    </li>
                                </ol>
                                <p class="mo_openid_note_style"><span style="color: red">*</span><strong><?php echo mo_sl('According to the new updates of
                ...
                <tr>
                    <td><br/><b><input type="submit" name="submit" value="<?php echo mo_sl('Save');?>" style="width:150px;background-color:#0867b2;color:white;box-shadow:none;text-shadow: none;"  class="button button-primary button-large" />
                        </b>
                    </td>
                </tr>
            </table>
    ...
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('<?php echo mo_sl('Share Counts');?>');
    </script>
