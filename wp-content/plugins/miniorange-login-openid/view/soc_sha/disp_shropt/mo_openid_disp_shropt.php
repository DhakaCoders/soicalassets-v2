           ...
           value="<?php echo wp_create_nonce( 'mo-openid-enable-share-display-nonce' ); ?>"/>
            ...
            <div class="mo_openid_table_layout" >
                <table style="height: 200%">
                    ...
                    <div id="above">
           <strong style="font-size: 14px"><?php echo mo_sl('Select the options where you want to display social share icons');?></strong>
                    </div>
                    <div id="upleft" style="font-size: 14px;">


                        <label class="mo_openid_checkbox_container"> <?php echo mo_sl('Home Page');?>
                        ...
                        <label class="mo-openid-radio-container"><?php echo mo_sl('Before content');?>
                        ...
                        <label class="mo-openid-radio-container"><?php echo mo_sl('After content');?>
                        ...
                        <label class="mo-openid-radio-container"><?php echo mo_sl('Both before and after content');?>
                        ...
                        <label class="mo_openid_checkbox_container"> <?php echo mo_sl('Blog Post');?>
                        ...
                        <label class="mo_openid_checkbox_container"> <?php echo mo_sl('Static Pages');?>
                    ...
                    <div id="upright" style="font-size: 14px;">
                        ...
                        <label class="mo_openid_checkbox_container" ">  <?php echo mo_sl('BBPress Forums Page');?>
                        ...
                        <label class="mo_openid_checkbox_container"> <?php echo mo_sl('BBPress Topic Page');?>
                        ...
                        <label class="mo_openid_checkbox_container"> <?php echo mo_sl('BBPress Reply Page');?>
...
<div style="margin-left: 8%">
                    ...
                    <tr>
                        <td><br /><b><input type="submit" name="submit" value="<?php echo mo_sl('Save');?>" style="width:150px;background-color:#0867b2;color:white;box-shadow:none;text-shadow: none;"  class="button button-primary button-large" /></b>
                        </td>
                    </tr>
