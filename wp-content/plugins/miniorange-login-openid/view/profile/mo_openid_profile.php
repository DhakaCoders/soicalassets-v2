...
function mo_openid_profile(){
    ...
    else if(!mo_openid_is_customer_registered())
    {
            ...
            <form name="f" method="post" action="" id="register-form">
                ...
                <div class="mo_openid_table_layout">
                    ...
                    <table class="mo_openid_settings_table" style="padding-right: 20%">
                        ...
                        <tr>
                            <td><b><font color="#FF0000">*</font><?php echo mo_sl('Password');?>:</b></td>
                        ...
                        <tr>
                            <td><b><font color="#FF0000">*</font><?php echo mo_sl('Confirm Password');?>:</b></td>
                            <td><input class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 80%" required type="password"
                    ...
                    <br/><?php echo mo_sl('By clicking Submit, you agree to our');?> <a href="https://www.miniorange.com/usecases/miniOrange_Privacy_Policy.pdf" target="_blank"><?php echo mo_sl('Privacy Policy');?></a> <?php echo mo_sl('and');?> <a href="https://www.miniorange.com/usecases/miniOrange_User_Agreement.pdf" target="_blank"><?php echo mo_sl('User Agreement');?></a>.
                </div>
            </form>
        ...
        ?>
        <div class="mo_openid_table_layout">
            <h2><?php echo mo_sl('Thank you for registering with miniOrange');?>.</h2>
            <table border="1" style="background-color:#FFFFFF; border:1px solid #CCCCCC; border-collapse: collapse; padding:0px 0px 0px 10px; margin:2px; width:85%">
                <tbody><tr>
                    <td style="width:45%; padding: 10px;"><?php echo mo_sl('miniOrange Account Email');?></td>
                    <td style="width:55%; padding: 10px;"><?php echo get_option("mo_openid_admin_email"); ?></td>
                </tr>
                <tr>
                    <td style="width:45%; padding: 10px;"><?php echo mo_sl('Customer ID');?></td>
                    <td style="width:55%; padding: 10px;"><?php echo get_option("mo_openid_admin_customer_key"); ?></td>
                </tr>
                </tbody>
            </table>
